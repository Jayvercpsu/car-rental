...
import { Car, Star, Users, Settings, Fuel, ArrowLeft } from "lucide-react";
      ...
      <div className="pt-20 lg:pt-24">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 max-w-xl mx-auto">
            Browse our complete fleet, pick your perfect vehicle, and book instantly.
          </p>
        </div>
            ...
            >
              ...
              <div className="p-5 space-y-4">
                ...
                <div className="pt-3 border-t border-gray-100">
                  ...
                  >
                    {selectedCar?.id === car.id ? "Selected" : "Select & Book"}
                  </button>
                </div>
              </div>
            </div>
        ...
        {selectedCar && (
          <div id="booking-form" className="scroll-mt-24">
            ...
            <BookingForm preselectedCar={selectedCar.name} />
          </div>
        )}
